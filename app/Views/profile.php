        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <th>Name</th>
                        <td><?= esc($userInfo['user_name']) ?></td>
                    </tr>
                    <tr>
                        <th>Email</th>
                        <td><?= esc($userInfo['email']) ?></td>
                    </tr>
                    <tr>
                        <th>Phone</th>
                        <td><?= esc($userInfo['phone']) ?></td>
                    </tr>
                    <tr>
                        <th>Address</th>
                        <td><?= esc($userInfo['address']) ?></td>
                    </tr>
                    <tr>
                        <th>Table Number</th>
                        <td><?= esc($userInfo['tableNum']) ?></td>
                    </tr>
                    <tr>
                        <th> Edit </th>
                        <td>
                            <a class="btn btn-sm btn-primary me-2" href="/menu/menu/profile/edit"><i class="bi bi-pencil-fill"></i></a>
                        </td>
                     ...
                     <tr>
                        <th>See QR Codes</th>
                        <td>
                            <a class="btn btn-sm btn-success" href="/menu/menu/profile/see-qr-codes"><i class="bi bi-qr-code"></i> See QR Codes</a>
                        </td>
                    </tr>
                </tbody>
            </table>
